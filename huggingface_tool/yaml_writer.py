...
def write_model_deployment_to_yaml(
    hf_repo: str, max_seq_length: int, output_path="."
) -> None:
    """
...
def write_tokenizer_configs_to_yaml(
    hf_repo: str, prefix_token="", end_of_text_token="", output_path="."
) -> None:
    """
